...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { amount: @quotation.amount, approved: @quotation.approved, centimeter: @quotation.centimeter, client_id: @quotation.client_id, detail_body: @quotation.detail_body, detail_tattoo: @quotation.detail_tattoo } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { amount: @quotation.amount, approved: @quotation.approved, centimeter: @quotation.centimeter, client_id: @quotation.client_id, detail_body: @quotation.detail_body, detail_tattoo: @quotation.detail_tattoo } }
