...
class QuotationsTest < ApplicationSystemTestCase
  ...
  test "creating a Quotation" do
    ...
    check "Approved" if @quotation.approved
    fill_in "Centimeter", with: @quotation.centimeter
    fill_in "Client", with: @quotation.client_id
    fill_in "Detail body", with: @quotation.detail_body
    fill_in "Detail tattoo", with: @quotation.detail_tattoo
